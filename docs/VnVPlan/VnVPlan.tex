...
\noindent To avoid repeating repetitive information, to view the full set of unit tests, view the backend test cases within src/backend/tests
and frontend tests within src/frontend (all test files have test as suffix). For backend unit tests, cases were selected with the aim
...
Names of all test cases were also made to be self-descriptive, not requiring additional documentation within the code to explain what they
