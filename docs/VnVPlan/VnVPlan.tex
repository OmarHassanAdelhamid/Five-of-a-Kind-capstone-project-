...
changes implemented where necessary to improve UI design in the case that expectations are not reached.
...
Covers: NF223, \[***\] %Need to add a general requirement to SRS about entire system colours.
...
Covers: NF231, \[***\] %need reqs for rest of app about max-interactions
...
Covers: \[***\] %need to add a general requirement about availability/readability of user manual.
...
\item{test-CO-3 Project File Fail-safe\\} %CHECK THIS TEST if it makes sense.
...
Covers: %cite dev plan here somehow; also add any other standards from other language we are aligning with.
...
How test will be performed: Developer inputs the entirety of the application's code into a linting program and takes note of all
...
Covers: % this req needs to be added to the SRS
