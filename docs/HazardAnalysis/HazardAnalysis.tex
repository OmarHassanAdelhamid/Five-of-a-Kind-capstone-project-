...
\begin{itemize}
    ...
    \item \textbf{Key Functions:} 
    \begin{itemize}
        \item Generate an interactible 3D visualization of the voxel model (as per F221, F223, NF221)
        \item Allow users to view layers of the voxel model in isolation (as per F225) %this number will need to be updated
        \item Visualize voxels selected by the user (as per F226)                      %same with this one.
    \end{itemize}
\end{itemize}

\subsection{Property Module}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Key Functions:} 
    \begin{itemize}
        \item Save voxel models for later editing (as per F243)
