...
This usability evaluation corresponds primarily to tests \texttt{test-US-1} (Design Acceptance and Intuitivity Survey) and \texttt{test-US-3} (Design Ease of Use Test) defined in the VnV Plan.
