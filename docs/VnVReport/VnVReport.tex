...
\begin{tabular}{l l} 
  ...
  INT & Integration (Import to Visualization)\\
  EM & Editing Manager\\
  XM & Export Manager\\
...
\begin{longtable}{c
  ...
  TC8 & F216 & Import a model containing more than MAX\_DISPLAY voxels. & System partitions the model into display sections not exceeding MAX\_VOXELS & All assertions are met and passed by backend unit test & \cellcolor{green} Pass \\ \midrule
...
\begin{longtable}{c
  ...
  TC15 & F222 & Open a voxelized project from file directory where the number of layers is greater than MAX\_DISPLAY & System displays a partitions panel with more than 1 partition & All assertions are met and passed by frontend unit test & \cellcolor{green} Pass \\ \midrule
  TC16 & F222 & Open a voxelized project from file directory where the number of layers is less than MAX\_DISPLAY & System displays a partitions panel with only 1 partition & All assertions are met and passed by frontend unit test & \cellcolor{green} Pass \\
...
\begin{table}[H]
\centering
\caption{Trace Between Visualization Manager and Integration Test Cases and Corresponding Requirements}
...
The following tables show the traceability between the test cases in this report and the modules defined in the \href{https://github.com/OmarHassanAdelhamid/Five-of-a-Kind-capstone-project-/blob/main/docs/Design/SoftArchitecture/MG.pdf}{Module Guide}. A filled cell (\xbox) indicates that the test case exercises or verifies behaviour involving that module; an empty cell (\obox) indicates it does not. The module identifiers (M1, M2, \ldots) correspond to the modules in the MG: Input Interpreter (M1), Voxel Slicing (M2), Display Partitioning (M3), Project Manager (M4), Interaction Controller (M7), Visualization State Manager (M8), Model Manager (M9), History Manager (M10), Voxel Tracking (M12), Highlight Manager (M13), Export Validation (M14), Export Manager (M15), Error Diagnostic Handler (M16), Model Structure (M17), Graphics Adapter (M18), and Export Structure (M20).
...
\begin{table}[H]
\centering
\caption{Trace Between Visualization Manager and Integration Test Cases and Modules}
...
\begin{table}[H]
\centering
\caption{Trace Between Editing Manager Test Cases and Modules}
...
\begin{tabular}{l|*{16}{c}}
\toprule
\textbf{TC} & M1 & M2 & M3 & M4 & M7 & M8 & M9 & M10 & M12 & M13 & M14 & M15 & M16 & M17 & M18 & M20 \\
\midrule
TC62 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \xbox & \obox & \obox & \xbox & \obox & \obox \\
TC63 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \xbox & \obox & \obox & \xbox & \obox & \obox \\
TC64 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \obox & \xbox & \obox & \xbox \\
TC65 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \obox & \xbox & \obox & \obox \\
TC66 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \xbox & \obox & \obox & \obox & \xbox \\
TC67 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \obox & \xbox & \obox & \xbox \\
TC68 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \xbox & \obox & \obox & \xbox & \obox & \obox \\
TC69 & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \xbox & \obox & \obox & \xbox & \obox & \obox \\
\bottomrule
\end{tabular}
}
\end{table}
