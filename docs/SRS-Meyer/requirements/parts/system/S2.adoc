...
. [[F244]] *Export model:* Exportation Manager shall generate a file that provides an updated model in the format of the original import file. (F244)

. [[F245]] *Exportation progress tracker:* Exportation Manager shall provide a progress bar that gives a visual indicator of how far along the software is in the exportation process. (F245)
