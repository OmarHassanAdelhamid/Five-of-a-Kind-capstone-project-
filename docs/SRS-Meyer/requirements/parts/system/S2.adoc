...
. [[NF241]] *Printing compliance:* Exportation Manager shall ensure that the exported file is compatible and easily interpreted by the existing Java software that is used to interpret geometric models for printing. (NF241)
