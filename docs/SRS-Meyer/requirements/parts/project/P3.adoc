...
**Relationship to user stories and requirements**

<<p4, (P.4) Tasks and Deliverables>> defines the sprint backlogs as numbered user stories (1–31) with story-point estimates and business-value rationale. This section **(P.3)** ties those stories to a calendar and to course milestone dates. The sprint numbers match between (P.3) and (P.4): each sprint here corresponds to the same-numbered sprint in (P.4). 
...
- **Epic 1: Problem Statement, Proof of Concept, and Development Plan** (September 22, 2025)
  ...
  * **(P.4) alignment:** User stories 1, 3–6 (workflow pain points, scope, PoC plan, team structure, project infrastructure); supports early problem and plan artifacts before full SRS work.
...
- **Epic 2: SRS and Hazard Analysis Development** (October 6, 2025)
  ...
  * **(P.4) alignment:** User stories 2, 7–13 (stakeholder needs, full functional and non-functional requirements, architecture diagrams, UI mockups, hazard analysis, MoSCoW prioritization, integration interfaces).
...
- **Epic 3: Verification and Validation Planning** (October 27, 2025)
  ...
  * **(P.4) alignment:** User stories 14–20 (QA strategy, integration and system-level test planning, acceptance and performance validation planning, stakeholder validation planning, test documentation).
...
- **Epic 4: System Architecture and Design Specification** (November 10, 2025)
  ...
  * **(P.4) alignment — Sprint 2:** User stories 21–22 (full architecture and UI design, file import and reliability features including undo/redo).
...
- **Epic 7: Revision 0 System Demonstration** (February 2-11, 2026)
  ...
  * **(P.4) alignment — Sprint 3:** User stories 26–27 (end-to-end voxel property assignment implementation, testing and Rev 0 demonstration preparation).
...
- **Epic 8: Verification, Validation, and Extras** (March 9, 2026)
  ...
  * **(P.4) alignment — Sprint 4:** User stories 28–30 (extras and UX polish; performance validation, user testing, and user manual).
...
- **Epic 9: Final System Demonstration** (March 23-26, 2026)
  ...
  * **(P.4) alignment — Sprint 4:** User story 31 (final demonstration, validation, and delivery activities).
...
- **Epic 10: Final Documentation and EXPO** (April 6, 2026 & TBD)
  ...
  * **(P.4) alignment — Sprint 4:** User stories 30–31 (final documentation package, handover, EXPO and project closure).
