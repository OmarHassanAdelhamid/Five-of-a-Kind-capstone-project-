...
- `metadata.adoc` Contains metadata for the document, including the title, author, and revision history.
- `index.adoc` The root file for the document, which includes the metadata and the sections of the document.
- `appendix` The appendix for the document, which includes the bibliography and the appendices to the document.
