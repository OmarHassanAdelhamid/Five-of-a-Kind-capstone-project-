...
The following are roles that each team member will pick up throughout the year, or according to the situation.
Therefore, specific individuals are not listed here. In addition, multiple members may take on the same role (eg. in the
case of Domain Expert).\\
