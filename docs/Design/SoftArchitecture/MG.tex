...
\item [\refstepcounter{mnum} \mthemnum \label{m1}:] STL Interpreter Module
...
\multirow{7}{0.3\textwidth}{Behaviour-Hiding Module} & STL Interpreter Module\\
...
\subsubsection{STL Interpreter Module (\mref{m1})}
