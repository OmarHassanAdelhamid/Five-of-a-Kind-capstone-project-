...
\acref{acInputConstraints} & \mref{m1}\\
\acref{acVoxelSize} & \mref{m2}\\
\acref{acVoxelization} & \mref{m2}\\
\acref{acMagnetization} & \mref{m8}, \mref{m17}\\
\acref{acSelection} & \mref{m7}, \mref{m12}\\
\acref{acExport} & \mref{m15}, \mref{m20}\\
