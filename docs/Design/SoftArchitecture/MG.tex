...
\begin{description}
  ...
  \item[Implemented By:] \progname{}
  \item[Type of Module:] Abstract Object: a computational component that provides read-only querying and tracking of voxels with specific properties within the voxel grid.
\end{description}
