...
% Define commonly used names to avoid "Undefined control sequence" errors
\newcommand{\progname}{\projectname}
\newcommand{\teamname}{\projectname{} Team}
\newcommand{\authname}{\projectname{} Team}
