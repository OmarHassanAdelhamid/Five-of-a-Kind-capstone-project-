...
F231 &
\obox & \obox & \obox & \obox & \obox & \obox & \xbox & \obox & \xbox & \xbox &
...
\midrule
\acref{acInput} & \mref{m1}\\
\acref{acInputConstraints} & \mref{m1}, \mref{m14}\\
\acref{acVoxelSize} & \mref{m2}, \mref{m17}\\
\acref{acVoxelization} & \mref{m2}\\
\acref{acMagnetization} & \mref{m8}, \mref{m9}, \mref{m17}\\
\acref{acSelection} & \mref{m7}, \mref{m12}, \mref{m13}\\
\acref{acExport} & \mref{m5}, \mref{m15}, \mref{m20}\\
\acref{acDataStructure} & \mref{m17}\\
\acref{acUI} & \mref{m7}, \mref{m8}, \mref{m18}\\
\bottomrule
\end{tabular}
