...
Adapted from ideas discussed in \textit{An Accurate Method for Voxelizing Polygon Meshes}, Huang et. al.\\
\textit{Definitions}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Exceptions:} None
\end{itemize}
\texttt{mapVoxels(voxels: list[Voxel], partition: PartitionItem) -> list[Voxel]}
\begin{itemize}
