...
\subsection{Uses}
\begin{itemize}
  \item \texttt{VoxelSlicing} for voxel grid generation.
  \item \texttt{SerializationManager} for project deserialization.
  \item \texttt{ModelManager} for organizing parsed geometry data.
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{ModelManager} to receive thegenerated voxel grid for management and updates.
\end{itemize}
...
\subsection{Uses}
\begin{itemize}
  \item \texttt{ModelManager} to supply the model state to be serialized.
  \item \texttt{DatabaseHandler} to store the serialized data persistently.
  \item \texttt{ExportManager} to export the encoded model structures to files.
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{AutosaveManager} to reference latest history state during periodic saves.
  \item \texttt{ErrorDiagnosticHandler} to handle error handling and diagnostics.
\end{itemize}
...
\begin{itemize}
  ...
  \item \texttt{ModelManager} to provide model structures to persist.
  \item \texttt{ErrorDiagnosticHandler} to handle error handling and diagnostics.
\end{itemize}
