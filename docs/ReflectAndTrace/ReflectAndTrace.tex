...
Team & Increased commenting on ModelViewer & Added more comments on the ModelViewer, a component heavily inspired by Three.js examples. Added some explanation on its complexity, and what authors worked on it. & \href{https://github.com/OmarHassanAdelhamid/Five-of-a-Kind-capstone-project-/issues/455}{Issue \#455} \\ \hline
Team & Increased commenting on the backend files & Added more comments on the backend main components, mainly router.py, config.py, main.py, models.py. Added author contributions as well. & \href{https://github.com/OmarHassanAdelhamid/Five-of-a-Kind-capstone-project-/issues/457}{Issue \#457} \\ \hline
